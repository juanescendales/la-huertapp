...
export default function useCalendarEventHandler(props, clearForm, emit) {
  ...
  const guestsOptions = [
    { avatar: require('@/assets/images/avatars/1-small.png'), name: 'Diana Lopez' },
    { avatar: require('@/assets/images/avatars/7-small.png'), name: 'Daniela Vergara' },
    { avatar: require('@/assets/images/avatars/9-small.png'), name: 'Antonia Vega' },
    { avatar: require('@/assets/images/avatars/11-small.png'), name: 'Carlota Abad' },
  ]
